                ...
                <form action="{{ route('organizations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="d-flex gap-4 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="has_multiple_companies" id="multi_yes" value="1" {{ old('has_multiple_companies') == '1' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="multi_yes">Yes</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="has_multiple_companies" id="multi_no" value="0" {{ old('has_multiple_companies') == '0' || old('has_multiple_companies') === null ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mt-4">
                            <button type="submit" class="btn btn-primary px-5">Save Organization</button>
        ...
        <div class="card shadow-sm border-0 h-100">
            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div>
                        <input type="file" name="logo" id="logo-input" class="d-none" accept="image/*" form="{{ \Illuminate\Support\Str::random(10) }}"> <!-- Fake form attribute to avoid double filing -->
                    </div>
                    ...
                    <p class="text-muted small">Max size: 2MB. Format: JPG, PNG, SVG</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Special script to handle the logo input belonging to the actual form -->
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const logoInput = document.getElementById('logo-input');
        const realFormInput = document.createElement('input');
        realFormInput.type = 'file';
        realFormInput.name = 'logo';
        realFormInput.className = 'd-none';
        realFormInput.accept = 'image/*';
        document.querySelector('form').appendChild(realFormInput);
        ...
        btnUpload.addEventListener('click', () => realFormInput.click());

        realFormInput.addEventListener('change', function() {
